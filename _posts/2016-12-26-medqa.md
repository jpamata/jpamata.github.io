...
> Project Output
<p align="justify">Built a closed-domain question answering system for diabetes related questions </p>
<ol>
	<li>Console Based. Utilised:</li>
	<ul>
		<li>Java</li>
		<li>Apache OpenNLP</li>
		<li>Stanford CoreNLP</li>
	</ul>
	<li>Search Engine Based. Utilised:</li>
	<ul>
		<li>PHP</li>
		<li>NlpTools</li>
		<li>Elasticsearch</li>
